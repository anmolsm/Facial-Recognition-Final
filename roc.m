...
if verbose
    ...
    if p<=alpha
        ...
        hold off
        legend([HR1,HRC1,HCO1],'ROC curve','SVM classifier','Cut-off point','Location','NorthOutside')
        subplot(1,2,2)
        hold on
        HCO2=plot(1-xroc(J),yroc(J),'bo');
        hold off
        legend([HR2,HRC2,HCO2],'ROC curve','SVM classifier','Cut-off point','Location','NorthOutside')
